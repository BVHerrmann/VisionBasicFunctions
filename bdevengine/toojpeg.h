...
// void CallBackJpegByte(unsigned char oneByte) { fputc(oneByte, myFileHandle); } // save byte to file
// => let's go !
// TooJpeg::writeJpeg(CallBackJpegByte, mypixels, 1024, 768);
...
namespace TooJpeg
{
  ...
  // auto CallBackJpegByte = [](unsigned char oneByte) { fputc(oneByte, output); };
